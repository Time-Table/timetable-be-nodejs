...
const FUNNELS = [
  ...
  },
  {
    ...
    meaning:
      "입력 전 이탈 지점을 찾는 보조 지표입니다. 기간 내 브라우저의 이벤트를 비교하며 같은 표·행동 순서·유효한 시간 입력을 보장하지 않습니다. 대표 성과는 위의 3인 입력 달성률로 확인합니다.",
    steps: [
      {
...
const MATURITY_FUNNEL = {
  ...
  meaning:
    "현재 남아 있는 표의 등록 참여자 수입니다. 시간을 입력하지 않은 사람도 포함하고 취소·표 삭제에 따라 줄어듭니다. 과거 표도 포함하는 참고 현황이며, 마감 전 3인 입력 달성 이력과는 다릅니다.",
  steps: [
    {
      threshold: 0,
      label: "생성된 테이블",
